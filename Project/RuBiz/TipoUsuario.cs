...
namespace RuBiz
{
    ...
    public partial class TipoUsuario: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int Id_TipoUsuario
        {
            ...
            set
            {
                if (_id_TipoUsuario != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'Id_TipoUsuario' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
